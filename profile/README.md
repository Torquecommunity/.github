...
<img src="https://skillicons.dev/icons?i=ts,js,python,go,rust,nextjs,react,nodejs,electron,fastapi,docker,linux,postgres,mysql,redis,mongodb,firebase,git,github,githubactions,vscode,figma,cloudflare,tailwind,bash"/>
